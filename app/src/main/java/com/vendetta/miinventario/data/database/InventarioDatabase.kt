...
import com.vendetta.miinventario.data.database.dao.DataClientDao
...
@Database(entities = [UserEntity::class,VentasEntity::class,ProductosEntity::class,FinanzasEntity::class,DataClientEntity::class], version = 1)
abstract class InventarioDatabase: RoomDatabase() {
abstract val userDao: UserDao
abstract val ventasDao: VentasDao
abstract val productosDao:ProductosDao
abstract val finanzasDao:FinanzasDao
abstract val dataClientDao: DataClientDao
